...
/* Fun‡es utilitßrias retiradas de "UNIX Networking Programming" */

/* LŠ nbytes de um ficheiro/socket.
...
/* LŠ uma linha de um ficheiro/socket (at‰ \n, maxlen ou \0).
...
int maxlen;
{
	...
	/* Nƒo esquecer de terminar a string */
